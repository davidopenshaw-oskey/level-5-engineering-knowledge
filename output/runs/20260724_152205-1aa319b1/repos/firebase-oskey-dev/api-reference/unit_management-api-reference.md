...
# Module API Reference: unit_management
...
This document contains the verified API contracts, exported Cloud Function callables, request/response models, and data types for the `unit_management` module.
