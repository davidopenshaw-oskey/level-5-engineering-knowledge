...
This section is detailed in the companion `api-contracts/apps-api-contract.md` document.

---

## 8. API Endpoints

This section is detailed in the companion `api-reference/apps-api-reference.md` document.
