...
# Module API Contract Specification: admin
...
This document contains the verified API contracts, exported Cloud Function callables, request/response models, and data types for the `admin` domain module.
