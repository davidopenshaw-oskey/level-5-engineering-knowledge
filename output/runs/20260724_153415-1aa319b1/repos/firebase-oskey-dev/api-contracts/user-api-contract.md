...
# Module API Contract Specification: user
...
| **Exported Callables** | 43 |
| **Type Aliases / Enums** | 190 |
...
This document contains the verified API contracts, exported Cloud Function callables, request/response models, and data types for the `user` domain module.

---

## 2. HTTPS Callable Functions (43 Endpoints)

### `getInhabitantType`

- **Request Type**: `OSKGetInhabitantTypeRequest`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/user/index.ts` (Line undefined)
...
| Property Name | Property Type | Optional |
| :--- | :--- | :--- |
| `publicProfile` | `OSKUserUpdatesPublicProfileRequest` | No |
| `phoneNumber` | `OSKPhoneNumber | undefined` | No |
...
| `newUserOnboarding` | `{ activateBuildingAccess?: OSKOnboardingStatus | undefined; enrollMFA?: OSKOnboardingStatus | undefined; }` | No |
...
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/user/modules/user_activity/index.ts` (Line undefined)
...
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/user/modules/user_device/index.ts` (Line undefined)
...
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/user/modules/user_invitation/index.ts` (Line undefined)
...
| `buildingId` | `string` | No |
| `unitId` | `string` | No |
| `invitation` | `OSKUserInvitationSentRequest` | No |
...
| :--- | :--- | :--- |
| `userId` | `string` | No |
| `category` | `OSKInvitationCategory | undefined` | No |
| `pageSize` | `number | undefined` | No |
| `nextPageToken` | `string | undefined` | No |
...
| Property Name | Property Type | Optional |
| :--- | :--- | :--- |
| `invitation` | `Omit<OSKUserInvitationSent, "accessRights"> & { accessRights: OSKAccessRightWithDates[]; }` | No |
...
| `unitId` | `string` | No |
| `invitationId` | `string` | No |
| `invitationType` | `OSKUserInvitationType` | No |

### `onInsertOrUpdateNotificationToken`

- **Request Type**: `OSKUserNotificationTokenInsertOrUpdateBody`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/user/modules/user_notification/index.ts` (Line undefined)
...
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/user/modules/user_organization/index.ts` (Line undefined)
...
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/user/modules/user_pincode/index.ts` (Line undefined)
...
- **Request Type**: `OSKUserPincodeDeleteRequest`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/user/modules/user_pincode/index.ts` (Line undefined)
...
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/user/modules/user_settings/index.ts` (Line undefined)
...
## 3. Data Models & Type Definitions (190 Types)
