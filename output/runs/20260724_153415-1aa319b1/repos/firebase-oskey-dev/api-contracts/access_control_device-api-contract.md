...
# Module API Contract Specification: access_control_device
...
| Property | Value |
| :--- | :--- |
| **Domain Module** | `access_control_device` |
...
This document contains the verified API contracts, exported Cloud Function callables, request/response models, and data types for the `access_control_device` domain module.
