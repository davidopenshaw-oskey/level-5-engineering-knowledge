...
# Module API Contract Specification: apps
...
This document contains the verified API contracts, exported Cloud Function callables, request/response models, and data types for the `apps` domain module.
