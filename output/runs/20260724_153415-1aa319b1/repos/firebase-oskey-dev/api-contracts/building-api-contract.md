...
# Module API Contract Specification: building
...
| Property | Value |
| :--- | :--- |
| **Domain Module** | `building` |
| **Repository** | `firebase-oskey-dev` |
| **Run ID** | `20260724_153415-1aa319b1` |
| **Exported Callables** | 38 |
| **Type Aliases / Enums** | 96 |
...
This document contains the verified API contracts, exported Cloud Function callables, request/response models, and data types for the `building` domain module.

---

## 2. HTTPS Callable Functions (38 Endpoints)

### `getAllBuildings`

- **Request Type**: `OSKBuildingGetAllRequestData`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/index.ts` (Line undefined)
...
| `imageFilename` | `string | undefined` | No |
...
| :--- | :--- | :--- |
| `organizationId` | `string` | No |
| `oldPropertyId` | `string | undefined` | No |
| `newPropertyId` | `string` | No |
| `buildingId` | `string` | No |
| `buildingData` | `Partial<OSKBuilding>` | No |
...
| `propertyId` | `string` | No |
| `organizationId` | `string` | No |
| `accessControlDeviceType` | `OSKAccessControlDeviceType | undefined` | No |

### `getActivityById`

- **Request Type**: `OSKGetBuildingActivityByIdRequest`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_activity/index.ts` (Line undefined)
...
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_door/index.ts` (Line undefined)
...
| `buildingId` | `string` | No |
| `doorId` | `string` | No |
| `data` | `Partial<Pick<OSKBuildingDoor, "name" | "streetAddress">>` | No |
| `organizationId` | `string` | No |

### `organizationUserGetAllBuildingDoors`

- **Request Type**: `OSKWithOrganizationId & { buildingId: string }`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_door/index.ts` (Line undefined)
...
- **Request Type**: `OSKWithOrganizationId & { buildingId: string; doorId: string }`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_door/index.ts` (Line undefined)
...
| `buildingId` | `string` | No |
| `doorId` | `string` | No |
| `adminsOrganizationId` | `string | undefined` | No |

### `onUpdateBuildingIntercomsTransferList`

- **Request Type**: `OSKIntercomCallTransferListRequest`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_intercom/index.ts` (Line undefined)
...
| `unitId` | `string` | No |
| `buildingId` | `string` | No |
| `callTransferList` | `OSKUserIntercomCallTransferListItem[]` | No |
...
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_settings/index.ts` (Line undefined)

#### Request Payload Schema
| Property Name | Property Type | Optional |
| :--- | :--- | :--- |
| `buildingId` | `string` | No |
| `buildingSettingsInputParams` | `OSKBuildingSettingsInputParams` | No |
...
| :--- | :--- | :--- |
| `buildingId` | `string` | No |
| `update` | `Partial<OSKBuildingSettingsInputParams>` | No |
...
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_unit/index.ts` (Line undefined)
...
| `buildingId` | `string` | No |
| `unitId` | `string` | No |
| `data` | `{ name: string; floor: string; unitNumber: string; streetAddress?: OSKStreetAddress | undefined; }` | No |
| `organizationId` | `string` | No |
...
- **Request Type**: `OSKWithOrganizationId & { buildingId: string; unitId: string }`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_unit/index.ts` (Line undefined)
...
- **Request Type**: `OSKAddNonAppUserRequest`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_unit/modules/building_unit_nonAppUser/index.ts` (Line undefined)
...
- **Request Type**: `OSKGetNonAppUserRequest`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_unit/modules/building_unit_nonAppUser/index.ts` (Line undefined)
...
| `buildingId` | `string` | No |
| `unitId` | `string` | No |
| `nonAppUserId` | `string` | No |

### `getAllNonAppUsers`

- **Request Type**: `OSKGetAllNonAppUsersRequest`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_unit/modules/building_unit_nonAppUser/index.ts` (Line undefined)
...
- **Request Type**: `OSKUpdateNonAppUserRequest`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_unit/modules/building_unit_nonAppUser/index.ts` (Line undefined)
...
- **Request Type**: `OSKDeleteNonAppUserRequest`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_unit/modules/building_unit_nonAppUser/index.ts` (Line undefined)
...
- **Request Type**: `OSKCreateNonAppUserAccessRequest`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_unit/modules/building_unit_nonAppUser/index.ts` (Line undefined)
...
- **Request Type**: `OSKCreateNonAppUserWithAccessRequest`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_unit/modules/building_unit_nonAppUser/index.ts` (Line undefined)
...
- **Request Type**: `OSKUpdateNonAppUserAccessDoorsRequest`
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_unit/modules/building_unit_nonAppUser/index.ts` (Line undefined)
...
- **Response Type**: `Promise<void>` / `Promise<any>`
- **Source File**: `functions/src/modules/building/modules/building_user/index.ts` (Line undefined)
...
| `doors` | `OSKDoorInfo[]` | No |
| `userType` | `OSKUserAccessType.OrganizationUser | OSKUserAccessType.OrganizationGuestUser` | No |

---

## 3. Data Models & Type Definitions (96 Types)
