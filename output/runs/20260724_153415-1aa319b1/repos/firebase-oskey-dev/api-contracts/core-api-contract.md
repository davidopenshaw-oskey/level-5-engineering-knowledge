...
# Module API Contract Specification: core
...
This document contains the verified API contracts, exported Cloud Function callables, request/response models, and data types for the `core` domain module.
