...
// repo's own pipeline scripts (00 onward). Ported byte-identical from
// android-intercom-oskey-io's own copy of this file (itself ported from
// angular-app-oskey-io's, deliberately scoped down to drop Phase-2/LLM-
// citation-restoration helpers that belong to LLM-synthesis output
// validation, not Phase 1 extraction). Add them back only when this repo's
// own Phase 2 actually needs them, not preemptively.
//
