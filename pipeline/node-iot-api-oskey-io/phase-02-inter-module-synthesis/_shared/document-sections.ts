 ...
 * sub-heading that happens to share the "N. Title" shape. Two real,
 * confirmed cases this must handle (governance/roadmap/firebase-oskey-dev/
 * 06b-v1-ab-factorial-experiment-results.md and tasks.md, both 2026-08-30):
 *
 ...
 * papering over. Uses the same selectRealSectionMatches disambiguation as
