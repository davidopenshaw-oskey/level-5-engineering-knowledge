...
//
// Deliberate fork of pipeline/facts-postgres-index/_shared/embedding-adapter.ts,
// not an import, as of the 2026-09-07 mcp-server/ repo-root move (governance/
// roadmap/mcp-direction/21-task1-mcp-server-repo-root-move-2026-09-07.md).
// See search.ts in this same folder for the real reasoning (possible future
// separate deployment of mcp-server vs. the pipeline) -- not kept in sync
// automatically with the pipeline's copy.
//
